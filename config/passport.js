...
module.exports = function(passport) {
    ...
    passport.use(
        ...
        function(req, username, password, done) {
            ...
            client.query("SELECT * FROM users WHERE username = $1",[username], function(err, rows) {
                if (err) {console.log('____1____'); return done(err);}
                ...
                if (rows.length) {
                    ...
                    client.query(insertQuery,[newUserMysql.username, newUserMysql.password],function(err, rows) {
